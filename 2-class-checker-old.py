...
img1 = 'resized_images_handprinted/black.png'
img2 = 'resized_images_handprinted/white.png'
import cv2 as ocr
import sys
import gc
import numpy as np
from os import listdir
from os.path import isfile, join
imageDir = '100-10-All-Data/ValidationSet'
classValueList = [65,217,337,599,810,932,1112,1117,1453,1515]
# imageFiles, _ = getData(dataPath=imageDir,pathSplitIndex = 2, channels=0, classCount=None, classValue=classValueList)
...
sc_dis = dissimilarityScore(printImages = False, seekLayer=9, originShiftBy =  6)
